    ...
    <div className="p-6 h-full overflow-y-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex space-x-2">
          <button className="px-4 py-2 bg-[#1a1a1a] text-slate-300 rounded text-sm hover:bg-[#1a1a1a]">Pause Stream</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-4 flex flex-col space-y-4">
          <div className="bg-[#141417] border border-[#2a2a2a] rounded-xl p-4 flex-1">
            ...
            <div className="space-y-3">
              {[1,2,3,4,5].map(i => (
                <div key={i} className="p-3 bg-[#1a1a1a]/50 rounded border border-[#2a2a2a] hover:border-[#2a2a2a] cursor-pointer">
                  <div className="flex justify-between text-xs mb-1">
                    <span className="text-white font-mono">REQ_{Math.floor(Math.random()*9000)+1000}</span>
        ...
        <div className="col-span-8 flex flex-col space-y-6">
          <div className="bg-[#141417] border border-[#2a2a2a] rounded-xl p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="px-3 py-1 bg-white/10 text-white border border-[#2a2a2a] rounded font-mono text-xl">
                2.12
              </div>
            </div>

            <div className="space-y-6">
              <ScoreRow label="Semantic Match" score={0.74} color="bg-[#1a1a1a]" />
              ...
              <div className="pt-4 mt-4 border-t border-[#2a2a2a] flex justify-between font-mono text-sm">
          ...
          <div className="bg-[#141417] border border-[#2a2a2a] rounded-xl p-6 flex-1">
             <h3 className="text-sm font-semibold text-slate-300 mb-4 uppercase tracking-wider flex items-center">
              <Database className="w-4 h-4 mr-2 text-[#a0a0a0]" />
              Token Packing Contribution
            </h3>
            <div className="w-full h-32 bg-[#1a1a1a] rounded border border-[#2a2a2a] flex items-center justify-center text-slate-600">
