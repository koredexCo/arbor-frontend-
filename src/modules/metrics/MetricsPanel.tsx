      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-[#0a0a0a] flex items-center">
            <BarChart className="w-6 h-6 mr-3 text-[#0a0a0a]" />
            Telemetry & Metrics
          </h1>
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-[#141417] border border-[#e8e8e8] rounded p-6 h-64 flex flex-col">
          <h3 className="text-sm font-semibold text-slate-300 mb-4 uppercase tracking-wider flex items-center">
             <Activity className="w-4 h-4 mr-2 text-[#0a0a0a]" />
             Retrieval Latency
          </h3>
        ...
        <div className="col-span-2 bg-[#141417] border border-[#e8e8e8] rounded p-6 h-64 flex flex-col">
          <h3 className="text-sm font-semibold text-slate-300 mb-4 uppercase tracking-wider flex items-center">
             <Activity className="w-4 h-4 mr-2 text-[#0a0a0a]" />
