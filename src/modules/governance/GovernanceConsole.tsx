    ...
    <div className="p-6 h-full overflow-y-auto">
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-8 flex flex-col space-y-6">
          <div className="bg-[#141417] border border-rose-900/50 rounded-xl p-6">
          ...
          <div className="bg-[#141417] border border-[#2a2a2a] rounded-xl p-6">
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={c.id} className="flex items-center justify-between p-3 border border-[#2a2a2a] rounded bg-[#1a1a1a]/50">
                   <div className="flex items-center space-x-3">
                     <span className="font-mono text-xs text-slate-500">{c.id}</span>
                     <span className="text-sm text-slate-300">{c.desc}</span>
                   </div>
                   <span className={`text-xs font-mono font-bold ${c.color || "text-white"}`}>{c.status}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="col-span-4 flex flex-col space-y-6">
          <div className="bg-[#141417] border border-[#2a2a2a] rounded-xl p-6">
             ...
             <div className="space-y-3">
               ...
               <button className="w-full py-3 bg-[#1a1a1a] text-slate-300 border border-[#2a2a2a] rounded flex items-center justify-center space-x-2 hover:bg-[#1a1a1a] transition-colors">
