  ...
  return (
    <div className="p-6 h-full overflow-y-auto">
      ...
      <div className="grid grid-cols-12 gap-6 h-[600px]">
        {/* Main Topology View */}
        <div className="col-span-8 bg-[#141417] border border-[#2a2a2a] rounded-xl flex items-center justify-center relative overflow-hidden">
           ...
           <div className="text-slate-600 border border-dashed border-[#2a2a2a] p-8 rounded text-center">
          ...
          <div className="bg-[#141417] border border-[#2a2a2a] rounded-xl p-6 flex-1">
             ...
             <div className="space-y-4">
               {[
                 ...
                 <div key={c.name} className="p-3 border border-[#2a2a2a] rounded bg-[#1a1a1a]/50">
                    ...
                    <div className="flex justify-between text-xs mb-1">
                      ...
                      <span className={c.trust > 0.8 ? "text-white" : c.trust > 0.5 ? "text-yellow-400" : "text-rose-400"}>
                        {c.trust.toFixed(2)}
                      </span>
                    </div>
