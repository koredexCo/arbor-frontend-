      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-[#0a0a0a] flex items-center">
            <Box className="w-6 h-6 mr-3 text-[#52504b]" />
            Sandbox Environment
          </h1>
          <p className="text-slate-400 mt-1">Isolated civilization experimentation and mutation simulation.</p>
        </div>
        <button className="px-4 py-2 bg-purple-600 hover:bg-purple-500 text-[#0a0a0a] rounded text-sm flex items-center shadow-[0_0_15px_rgba(168,85,247,0.4)] transition-all">
           <Play className="w-4 h-4 mr-2" />
           Run Simulation
        </button>
      </div>

      <div className="flex-1 bg-[#141417] border border-[#e8e8e8] rounded p-6 flex flex-col items-center justify-center text-slate-500">
