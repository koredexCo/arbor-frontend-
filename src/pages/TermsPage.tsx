    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 text-[#52504b]">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">Acceptance</h2>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">What you can do</h2>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">What you cannot do</h2>
          <ul className="list-disc pl-6 space-y-2 text-[#52504b]">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">Your content</h2>
          <p className="text-[#52504b]">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">Service availability</h2>
          <p className="text-[#52504b]">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">Free tier limits</h2>
          <p className="text-[#52504b]">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-[#0a0a0a] mb-3">Limitation of liability</h2>
          <p className="text-[#52504b]">
